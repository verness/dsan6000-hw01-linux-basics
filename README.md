...
With that workflow in mind, your job is now to figure out how to **browse the provided S3 bucket**, which contains the hourly data from midnight (EDT) on 31 August 2026 to 11:59pm on 1 September 2026, and then **download the `.csv` files** from this bucket into the `data` subdirectory you created above. Specifically:
